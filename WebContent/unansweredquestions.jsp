...
<html>
  ...
  <body>
	...
	for (var mes in rawJSON) {
		...
		console.log(qId);
		$("nav#navbar1").after("<div class='dropdown'><div class='container-fluid'><button class='btn btn-3 btn-3e col-xs-12' type='button' id='"+qId+"' data-toggle='dropdown'>" + quserId + " asked: " + qtext + " at " + qtime + "</button></div></div>");		
	}	
